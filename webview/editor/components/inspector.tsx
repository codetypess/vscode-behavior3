            ...
            form.setFieldValue(
                ...
                (Array.isArray(value) ? value : []).map((item) => {
                    if (isJsonType(type)) {
                        return item === null
                            ? "null"
                            : JSON.stringify(item ?? arg.default, null, 2);
                    }
                    return item;
                })
            );
        ...
        def.args.forEach((arg) => {
            ...
            if (value !== null && value !== undefined && value !== "") {
                ...
                if (isNodeArgArray(arg)) {
                    ...
                    data.args[arg.name] = !isNodeArgOptional(arg)
                        ? arr
                        : arr.length
                          ? arr
                          : undefined;
        ...
        <Flex gap={4} style={{ width: "100%" }}>
            <Space.Compact style={{ width: "100%" }}>
                <div
                    ...
                    onClick={() =>
                        local.name &&
                        useWorkspace.getState().editor?.dispatch?.("clickVar", local.name)
                    }
                >
                    <AimOutlined />
    ...
    const resetArgField = (arg: NodeArg) => {
        ...
        if (isNodeArgArray(arg)) {
            ...
            form.setFieldValue(
                ...
                originalValue === null
                    ? "null"
                    : JSON.stringify(originalValue ?? arg.default, null, 2)
            );
        } else {
        ...
        <>
            ...
            <div className="b3-inspector-content" style={{ overflow: "auto", height: "100%" }}>
                ...
                >
                    ...
                    {groupDefs.length > 0 &&
                    (def as NodeDef & { group?: string[] }).group?.length ? (
                        <Form.Item
                            name="group"
                            label={t("node.group")}
                            rules={[
                                                                ...
                                                                <Flex key={field.key} gap={4}>
                                                                    ...
                                                                    >
                                                                        <AutoComplete
                                                                            ...
                                                                            onBlur={submit}
                                                                            filterOption={
                                                                                filterOption as unknown as boolean
                                                                            }
                                                                        />
                                                                    </Form.Item>
                                                                    <MinusCircleOutlined
                                    ...
                                    >
                                        <Form.Item
                                            ...
                                            rules={[
                                                {
                                                    required,
                                                    message: t("fieldRequired", { field: desc }),
                                                },
                                                ({
                                                    getFieldValue,
                                                    setFieldValue,
                                        ...
                                        >
                                            ...
                                            {hasArgOptions(arg) && (
                                                <Select
                                                    ...
                                                    onChange={submit}
                                                    options={(
                                                        getNodeArgOptions(arg, nodeArgs) ?? []
                                                    ).map((o) => ({
                                                        value: o.value,
                                                        label: `${o.name}(${o.value})`,
                                                    }))}
                ...
                {(disabled || subtreeNode || !!node.path) && (
                    <Flex style={{ paddingTop: 30 }}>
                        <Button
                            ...
                            icon={<EditOutlined />}
                            onClick={() =>
                                useWorkspace.getState().editor?.dispatch?.("editSubtree")
                            }
                        >
                            {t("editSubtree")}
                        </Button>
                                        ...
                                        rules={[
                                            {
                                                validator(_, value: VarItem) {
                                                    if (
                                                        ...
                                                        return Promise.reject(
                                                            new Error(t("tree.vars.invalidName"))
                                                        );
                                                    }
                                                    if (!value.desc) {
                                                        return Promise.reject(
                    ...
                    args: d.args.map((arg) => {
                        if (
                            ...
                            return {
                                ...
                                options: [
                                    {
                                        source: arg.options as unknown as Array<{
                                            name: string;
                                            value: unknown;
                                        }>,
                                    },
