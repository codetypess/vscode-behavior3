import { subtreeNeedsMissingIds } from "../../shared/misc/b3util";
import { basenameWithoutExt, readTree, treeDataForPersistence, writeTree } from "../../shared/misc/util";
import type {
  PersistedNodeModel,
  PersistedTreeModel,
...
export const collectReachableSubtreePaths = (root: PersistedNodeModel): WorkdirRelativeJsonPath[] => {
